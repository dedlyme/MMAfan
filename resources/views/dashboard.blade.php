...
<div class="fixed inset-0 -z-10">
    ...
    <div class="absolute inset-0 bg-black/60"></div> {{-- Tumšāks pārklājums --}}
</div>
@endsection
...
@section('content')
    ...
    <section class="grid grid-cols-1 md:grid-cols-3 gap-8 pb-16">
        <!-- Active User -->
        <div class="bg-white/90 dark:bg-gray-800/90 rounded-3xl shadow-xl p-8 text-center backdrop-blur-md transition hover:-translate-y-2 hover:shadow-2xl duration-300">
